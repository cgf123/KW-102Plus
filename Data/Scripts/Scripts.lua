...
function OnSteelTalonsMammothCreatedNEW(self)
	ObjectHideSubObjectPermanently( self, "UGRAIL_01", true )
	ObjectHideSubObjectPermanently( self, "UGRAIL_02", true )
--	ObjectHideSubObjectPermanently( self, "UGRAILACCELERATOR_01", true )
--	ObjectHideSubObjectPermanently( self, "UGRAILACCELERATOR_02", true )
...
-- ################ NEW FUNCTION FOR 1.03 RGA #######################
function OnTitanCreatedNEW(self)
	ObjectHideSubObjectPermanently( self, "UGRail_01", true )
	ObjectHideSubObjectPermanently( self, "UGRail_Barrel", true )
	ObjectHideSubObjectPermanently( self, "MUZZLEFLASH_01", true )
--	ObjectHideSubObjectPermanently( self, "UGRAILACCELERATOR_01", true )
...
-- For BH Concabs
function OnConfessorSquadCreatedNEW(self)
	ExecuteAction("NAMED_SET_SPECIAL_POWER_COUNTDOWN", self, "SpecialPower_BlackHandConfessorCabalGetToGrenadeRange", 2);
end

function OnConfessorCreatedNEW(self)
	ExecuteAction("NAMED_SET_SPECIAL_POWER_COUNTDOWN", self, "SpecialPower_BlackHandConfessorCabalFireGrenade", 2);
end
-- For Awakened/SilentOnes
function OnCyborgCreatedNEW(self)
	ObjectHideSubObjectPermanently( self, "WEAPON_PARTICLEBM", true )
	ExecuteAction("NAMED_SET_SPECIAL_POWER_COUNTDOWN", self, "EMPBlast", 2);
end

function OnCyborgSquadCreatedNEW(self)
	ExecuteAction("NAMED_SET_SPECIAL_POWER_COUNTDOWN", self, "EMPBlastGetInRange", 2);
end
-- For Enlightened
function OnImprovedCyborgCreatedNEW(self)
	ExecuteAction("NAMED_SET_SPECIAL_POWER_COUNTDOWN", self, "EMPBlast", 2);
end

function OnImprovedCyborgSquadCreatedNEW(self)
	ExecuteAction("NAMED_SET_SPECIAL_POWER_COUNTDOWN", self, "ImprovedEMPBlastGetInRange", 2);
end
-- ##########################################################################
